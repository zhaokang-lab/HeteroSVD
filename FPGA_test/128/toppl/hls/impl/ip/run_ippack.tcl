...
set IPName      "TopPL"
set Version     "1.0"
set DisplayName "Toppl"
set Revision    "2114080437"
...
set xo_kernel_name "TopPL"
set xo_kernel_files {/home/luanxinya/SVD/FPGA_test/128/pl/TopPL.cpp}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/luanxinya/SVD/FPGA_test/128/toppl/hls"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/home/luanxinya/SVD/FPGA_test/128/toppl/hls/.debug"
set xo_hls_files_dir "/home/luanxinya/SVD/FPGA_test/128/toppl/hls/impl/ip/hls_files"
set hdl_module_list {TopPL_flow_control_loop_pipe_sequential_init
...
set kernel_xo "/home/luanxinya/SVD/FPGA_test/128/pl/TopPL.xo"
set detect_deadlock_json "TopPL_message_dict.json"

## Variables
set Top "TopPL"
set TopNoPrefix "TopPL"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem0 m_axi_gmem1 m_axi_gmem2 m_axi_gmem3 sweep_tx0_0 sweep_rx0_0 sweep_tx0_1 sweep_rx0_1 norm_tx0 norm_rx0"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem1 {
        ...
        preferredUsageValue "MEMORY"
        handshake ""
        busParams "NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 64 MAX_WRITE_BURST_LENGTH 64 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE WRITE_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "gmem1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 2.222 machine 64 combinational 0 latency undef II x}
...
source -notrace "/usr/xilinx/Vitis_HLS/2023.2/common/scripts/ipxhls.tcl"
set outdir .
