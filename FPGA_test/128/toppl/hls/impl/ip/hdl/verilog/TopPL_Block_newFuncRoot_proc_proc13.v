...
module TopPL_Block_newFuncRoot_proc_proc13 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (convSet_1_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign convSet_1_din = empty;

endmodule //TopPL_Block_newFuncRoot_proc_proc13
