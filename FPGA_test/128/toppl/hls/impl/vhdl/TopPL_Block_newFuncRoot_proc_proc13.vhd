...
entity TopPL_Block_newFuncRoot_proc_proc13 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of TopPL_Block_newFuncRoot_proc_proc13 is 
...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, convSet_1_full_n)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (convSet_1_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    convSet_1_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, convSet_1_full_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            convSet_1_blk_n <= convSet_1_full_n;
        else 
    ...
    convSet_1_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            convSet_1_write <= ap_const_logic_1;
        else 
