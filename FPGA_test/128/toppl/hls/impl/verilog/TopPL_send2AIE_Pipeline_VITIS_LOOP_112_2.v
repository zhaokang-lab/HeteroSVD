...
module TopPL_send2AIE_Pipeline_VITIS_LOOP_112_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [127:0] send_fifo_0_read_reg_250;
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter4 == 1'b1) & ((sweep_tx0_0_TREADY == 1'b0) | (1'b1 == ap_block_state5_pp0_stage0_iter4))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter4 == 1'b1) & ((sweep_tx0_0_TREADY == 1'b0) | (1'b1 == ap_block_state5_pp0_stage0_iter4))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (send_fifo_0_empty_n == 1'b0);
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter4 = (sweep_tx0_0_TREADY == 1'b0);
end
...
assign data_temp_d0 = send_fifo_0_read_reg_250;

assign icmp_ln112_fu_150_p2 = ((ap_sig_allocacmp_j_1 == 6'd32) ? 1'b1 : 1'b0);

assign j_2_fu_156_p2 = (ap_sig_allocacmp_j_1 + 6'd1);

assign rem27_urem_fu_195_p2 = (trunc_ln112_reg_244_pp0_iter1_reg ^ 1'd1);

assign sweep_tx0_0_TDATA = {{trunc_ln118_reg_256_pp0_iter3_reg}, {tmp_s_reg_266}};

assign sweep_tx0_0_TKEEP = 16'd65535;

assign sweep_tx0_0_TLAST = 1'd0;

assign sweep_tx0_0_TSTRB = 'bx;

assign trunc_ln112_fu_162_p1 = ap_sig_allocacmp_j_1[0:0];

assign trunc_ln118_fu_180_p1 = send_fifo_0_dout[95:0];

assign zext_ln114_fu_184_p1 = trunc_ln112_reg_244_pp0_iter1_reg;

assign zext_ln115_fu_200_p1 = rem27_urem_fu_195_p2;

endmodule //TopPL_send2AIE_Pipeline_VITIS_LOOP_112_2
