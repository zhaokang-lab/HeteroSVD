...
module TopPL_send2AIE_3_Pipeline_VITIS_LOOP_112_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter4 == 1'b1) & ((norm_tx0_TREADY == 1'b0) | (1'b1 == ap_block_state5_pp0_stage0_iter4))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter4 == 1'b1) & ((norm_tx0_TREADY == 1'b0) | (1'b1 == ap_block_state5_pp0_stage0_iter4))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end
...
always @ (*) begin
    ap_block_state5_pp0_stage0_iter4 = (norm_tx0_TREADY == 1'b0);
end
...
assign icmp_ln112_fu_150_p2 = ((ap_sig_allocacmp_j_3 == 6'd32) ? 1'b1 : 1'b0);

assign j_4_fu_156_p2 = (ap_sig_allocacmp_j_3 + 6'd1);

assign norm_tx0_TDATA = {{trunc_ln118_reg_256_pp0_iter3_reg}, {tmp_s_reg_266}};

assign norm_tx0_TKEEP = 16'd65535;

assign norm_tx0_TLAST = 1'd0;

assign norm_tx0_TSTRB = 'bx;

assign rem27_urem_fu_195_p2 = (trunc_ln112_reg_244_pp0_iter1_reg ^ 1'd1);

assign trunc_ln112_fu_162_p1 = ap_sig_allocacmp_j_3[0:0];
...
endmodule //TopPL_send2AIE_3_Pipeline_VITIS_LOOP_112_2
