...
entity TopPL_RoundRobin_Pipeline_VITIS_LOOP_267_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of TopPL_RoundRobin_Pipeline_VITIS_LOOP_267_5 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln267_fu_104_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal receive_fifo_0_read_reg_146 : STD_LOGIC_VECTOR (127 downto 0);
    signal receive_fifo_1_read_reg_152 : STD_LOGIC_VECTOR (127 downto 0);
    signal j_9_fu_50 : STD_LOGIC_VECTOR (10 downto 0) := "00000000000";
    signal j_13_fu_98_p2 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    j_9_fu_50_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln267_fu_104_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    j_9_fu_50 <= j_13_fu_98_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_9_fu_50 <= ap_const_lv11_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                receive_fifo_0_read_reg_146 <= receive_fifo_0_dout;
                receive_fifo_1_read_reg_152 <= receive_fifo_1_dout;
            end if;
        end if;
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(receive_fifo_0_empty_n, receive_fifo_1_empty_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((receive_fifo_1_empty_n = ap_const_logic_0) or (receive_fifo_0_empty_n = ap_const_logic_0));
    end process;


    ap_block_state3_pp0_stage0_iter2_assign_proc : process(send_fifo_0_full_n, send_fifo_1_full_n)
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((send_fifo_1_full_n = ap_const_logic_0) or (send_fifo_0_full_n = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln267_fu_104_p2)
    begin
        if (((icmp_ln267_fu_104_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_j_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, j_9_fu_50, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j <= ap_const_lv11_0;
        else 
            ap_sig_allocacmp_j <= j_9_fu_50;
        end if; 
    end process;

    icmp_ln267_fu_104_p2 <= "1" when (ap_sig_allocacmp_j = ap_const_lv11_600) else "0";
    j_13_fu_98_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv11_1));
    ...
    receive_fifo_1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, receive_fifo_1_empty_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    receive_fifo_1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            receive_fifo_1_read <= ap_const_logic_1;
        else 
    ...
    send_fifo_0_din <= receive_fifo_0_read_reg_146;
    ...
    send_fifo_1_din <= receive_fifo_1_read_reg_152;
