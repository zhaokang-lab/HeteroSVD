...
entity TopPL_Block_newFuncRoot_proc_proc11 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of TopPL_Block_newFuncRoot_proc_proc11 is 
...
begin
    ...
    ap_block_state1_assign_proc : process(ap_start, ap_done_reg, convSet_0_full_n)
    begin
                ap_block_state1 <= ((ap_start = ap_const_logic_0) or (convSet_0_full_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;
    ...
    convSet_0_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, convSet_0_full_n)
    begin
    ...
    convSet_0_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            convSet_0_write <= ap_const_logic_1;
        else 
