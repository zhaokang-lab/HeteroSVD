...
entity TopPL_start_for_Send_U0 is 
    generic (
...
architecture rtl of TopPL_start_for_Send_U0 is

    component TopPL_start_for_Send_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_TopPL_start_for_Send_U0_ShiftReg : TopPL_start_for_Send_U0_ShiftReg
    generic map (
...
entity TopPL_start_for_Send_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end TopPL_start_for_Send_U0_ShiftReg;

architecture rtl of TopPL_start_for_Send_U0_ShiftReg is
