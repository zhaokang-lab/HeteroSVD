...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { syscontrol_1_dout { I 1 vector } syscontrol_1_num_data_valid { I 3 vector } syscontrol_1_fifo_cap { I 3 vector } syscontrol_1_empty_n { I 1 bit } syscontrol_1_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_send_fifo_0 \
    op interface \
    ports { send_fifo_0_din { O 128 vector } send_fifo_0_num_data_valid { I 10 vector } send_fifo_0_fifo_cap { I 10 vector } send_fifo_0_full_n { I 1 bit } send_fifo_0_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_send_fifo_1 \
    op interface \
    ports { send_fifo_1_din { O 128 vector } send_fifo_1_num_data_valid { I 10 vector } send_fifo_1_fifo_cap { I 10 vector } send_fifo_1_full_n { I 1 bit } send_fifo_1_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { receive_fifo_0_dout { I 128 vector } receive_fifo_0_num_data_valid { I 13 vector } receive_fifo_0_fifo_cap { I 13 vector } receive_fifo_0_empty_n { I 1 bit } receive_fifo_0_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { receive_fifo_1_dout { I 128 vector } receive_fifo_1_num_data_valid { I 13 vector } receive_fifo_1_fifo_cap { I 13 vector } receive_fifo_1_empty_n { I 1 bit } receive_fifo_1_read { O 1 bit } } \
} "
}
