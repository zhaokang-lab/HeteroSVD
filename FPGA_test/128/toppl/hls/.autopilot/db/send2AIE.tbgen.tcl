...
set portList { 
	...
	{ sweep_tx0_0_TREADY sc_in sc_logic 1 outacc 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sweep_tx0_0_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "sweep_tx0_0_V_data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "send_fifo_0", "Type" : "Fifo", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_send2AIE_Pipeline_VITIS_LOOP_112_2_fu_146", "Port" : "send_fifo_0", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "sweep_tx0_0_V_data_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "sweep_tx0_0",
				"BlockSignal" : [
					{"Name" : "sweep_tx0_0_TDATA_blk_n", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_send2AIE_Pipeline_VITIS_LOOP_112_2_fu_146", "Port" : "sweep_tx0_0_V_data_V", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "sweep_tx0_0_V_keep_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "sweep_tx0_0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_send2AIE_Pipeline_VITIS_LOOP_112_2_fu_146", "Port" : "sweep_tx0_0_V_keep_V", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "sweep_tx0_0_V_strb_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "sweep_tx0_0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_send2AIE_Pipeline_VITIS_LOOP_112_2_fu_146", "Port" : "sweep_tx0_0_V_strb_V", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			{"Name" : "sweep_tx0_0_V_last_V", "Type" : "Axis", "Direction" : "O", "BaseName" : "sweep_tx0_0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_send2AIE_Pipeline_VITIS_LOOP_112_2_fu_146", "Port" : "sweep_tx0_0_V_last_V", "Inst_start_state" : "4", "Inst_end_state" : "5"}]}],
		"Loop" : [
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_send2AIE_Pipeline_VITIS_LOOP_112_2_fu_146", "Parent" : "0", "Child" : ["3"],
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_send2AIE_Pipeline_VITIS_LOOP_112_2_fu_146.flow_control_loop_pipe_sequential_init_U", "Parent" : "2"}]}
...
set Spec2ImplPortList { 
	...
	sweep_tx0_0_V_data_V { axis {  { sweep_tx0_0_TDATA out_data 1 128 }  { sweep_tx0_0_TREADY out_acc 0 1 } } }
	sweep_tx0_0_V_keep_V { axis {  { sweep_tx0_0_TKEEP out_data 1 16 } } }
	sweep_tx0_0_V_strb_V { axis {  { sweep_tx0_0_TSTRB out_data 1 16 } } }
	sweep_tx0_0_V_last_V { axis {  { sweep_tx0_0_TVALID out_vld 1 1 }  { sweep_tx0_0_TLAST out_data 1 1 } } }
}
