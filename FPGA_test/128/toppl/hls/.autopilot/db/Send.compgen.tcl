...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sweep_tx0_0_TVALID { O 1 bit } sweep_tx0_0_TREADY { I 1 bit } sweep_tx0_0_TLAST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sweep_tx0_1_TVALID { O 1 bit } sweep_tx0_1_TREADY { I 1 bit } sweep_tx0_1_TLAST { O 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { norm_tx0_TVALID { O 1 bit } norm_tx0_TREADY { I 1 bit } norm_tx0_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { syscontrol_0_dout { I 1 vector } syscontrol_0_num_data_valid { I 3 vector } syscontrol_0_fifo_cap { I 3 vector } syscontrol_0_empty_n { I 1 bit } syscontrol_0_read { O 1 bit } } \
} "
}
