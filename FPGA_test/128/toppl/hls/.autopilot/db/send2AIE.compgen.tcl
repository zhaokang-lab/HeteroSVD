...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler TopPL_send2AIE_data_temp_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sweep_tx0_0_TDATA { O 128 vector } sweep_tx0_0_TREADY { I 1 bit } } \
} "
} else {
