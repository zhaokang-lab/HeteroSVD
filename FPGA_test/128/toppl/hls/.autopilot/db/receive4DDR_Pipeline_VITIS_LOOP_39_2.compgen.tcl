...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { norm_rx0_TVALID { I 1 bit } norm_rx0_TDATA { I 128 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { norm_rx0_TREADY { O 1 bit } norm_rx0_TLAST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_data_temp_1 \
    op interface \
    ports { data_temp_1 { I 128 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_data_temp_2 \
    op interface \
    ports { data_temp_2 { I 128 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { receive_fifo_0_din { O 128 vector } receive_fifo_0_num_data_valid { I 13 vector } receive_fifo_0_fifo_cap { I 13 vector } receive_fifo_0_full_n { I 1 bit } receive_fifo_0_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 223 \
    name data_temp_5_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_data_temp_5_out \
    op interface \
    ports { data_temp_5_out { O 128 vector } data_temp_5_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 224 \
    name data_temp_4_out \
    type other \
    dir IO \
    reset_level 1 \
    sync_rst true \
    corename dc_data_temp_4_out \
    op interface \
    ports { data_temp_4_out_i { I 128 vector } data_temp_4_out_o { O 128 vector } data_temp_4_out_o_ap_vld { O 1 bit } } \
} "
}
