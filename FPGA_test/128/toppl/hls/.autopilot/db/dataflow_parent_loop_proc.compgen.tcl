...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { send_fifo_0_dout { I 128 vector } send_fifo_0_empty_n { I 1 bit } send_fifo_0_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { send_fifo_1_dout { I 128 vector } send_fifo_1_empty_n { I 1 bit } send_fifo_1_read { O 1 bit } } \
} "
}
