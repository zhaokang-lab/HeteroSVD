set moduleName RoundRobin_Pipeline_VITIS_LOOP_198_2
set isTopModule 0
...
set C_modelName {RoundRobin_Pipeline_VITIS_LOOP_198_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 512 regular {axi_master 1}  }
	{ sext_ln197 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "U","offset": { "type": "dynamic","port_name": "U","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln197", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ receive_fifo_0_dout sc_in sc_lv 128 signal 2 } 
	{ receive_fifo_0_num_data_valid sc_in sc_lv 13 signal 2 } 
	{ receive_fifo_0_fifo_cap sc_in sc_lv 13 signal 2 } 
	{ receive_fifo_0_empty_n sc_in sc_logic 1 signal 2 } 
	{ receive_fifo_0_read sc_out sc_logic 1 signal 2 } 
	...
	{ sext_ln197 sc_in sc_lv 58 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln197", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln197", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln197 { ap_none {  { sext_ln197 in_data 0 58 } } }
