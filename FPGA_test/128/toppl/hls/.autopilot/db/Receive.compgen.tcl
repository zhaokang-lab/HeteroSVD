...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sweep_rx0_1_TVALID { I 1 bit } sweep_rx0_1_TREADY { O 1 bit } sweep_rx0_1_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { norm_rx0_TVALID { I 1 bit } norm_rx0_TREADY { O 1 bit } norm_rx0_TLAST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { syscontrol_2_dout { I 1 vector } syscontrol_2_num_data_valid { I 3 vector } syscontrol_2_fifo_cap { I 3 vector } syscontrol_2_empty_n { I 1 bit } syscontrol_2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { receive_fifo_1_din { O 128 vector } receive_fifo_1_num_data_valid { I 13 vector } receive_fifo_1_fifo_cap { I 13 vector } receive_fifo_1_full_n { I 1 bit } receive_fifo_1_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 247
set RegSliceName TopPL_regslice_both
set RegSliceInstName TopPL_regslice_both_U
set CoreName ap_simcore_TopPL_regslice_both
