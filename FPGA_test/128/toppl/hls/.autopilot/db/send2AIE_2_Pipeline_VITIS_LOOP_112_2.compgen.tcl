...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_temp \
    op interface \
    ports { data_temp_address0 { O 1 vector } data_temp_ce0 { O 1 bit } data_temp_we0 { O 1 bit } data_temp_d0 { O 128 vector } data_temp_address1 { O 1 vector } data_temp_ce1 { O 1 bit } data_temp_q1 { I 128 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_temp'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sweep_tx0_1_TREADY { I 1 bit } sweep_tx0_1_TDATA { O 128 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sweep_tx0_1_TVALID { O 1 bit } sweep_tx0_1_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { send_fifo_1_dout { I 128 vector } send_fifo_1_num_data_valid { I 10 vector } send_fifo_1_fifo_cap { I 10 vector } send_fifo_1_empty_n { I 1 bit } send_fifo_1_read { O 1 bit } } \
} "
}
