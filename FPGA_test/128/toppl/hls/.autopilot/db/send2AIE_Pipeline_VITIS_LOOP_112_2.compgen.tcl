...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sweep_tx0_0_TREADY { I 1 bit } sweep_tx0_0_TDATA { O 128 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { sweep_tx0_0_TVALID { O 1 bit } sweep_tx0_0_TLAST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { send_fifo_0_dout { I 128 vector } send_fifo_0_num_data_valid { I 10 vector } send_fifo_0_fifo_cap { I 10 vector } send_fifo_0_empty_n { I 1 bit } send_fifo_0_read { O 1 bit } } \
} "
}
