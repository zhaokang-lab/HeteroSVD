set moduleName receive4AIE_1_Pipeline_VITIS_LOOP_76_2
set isTopModule 0
...
set C_modelName {receive4AIE.1_Pipeline_VITIS_LOOP_76_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ data_temp_9 int 128 regular  }
	{ data_temp_10 int 128 regular  }
	...
	{ data_temp_13_out int 128 regular {pointer 1}  }
	{ data_temp_12_out int 128 regular {pointer 2}  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "data_temp_9", "interface" : "wire", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "data_temp_10", "interface" : "wire", "bitwidth" : 128, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "data_temp_13_out", "interface" : "wire", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "data_temp_12_out", "interface" : "wire", "bitwidth" : 128, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ sweep_rx0_0_TVALID sc_in sc_logic 1 invld 2 } 
	...
	{ data_temp_9 sc_in sc_lv 128 signal 0 } 
	{ data_temp_10 sc_in sc_lv 128 signal 1 } 
	{ sweep_rx0_0_TDATA sc_in sc_lv 128 signal 2 } 
	{ sweep_rx0_0_TREADY sc_out sc_logic 1 inacc 5 } 
	{ sweep_rx0_0_TKEEP sc_in sc_lv 16 signal 3 } 
	{ sweep_rx0_0_TSTRB sc_in sc_lv 16 signal 4 } 
	{ sweep_rx0_0_TLAST sc_in sc_lv 1 signal 5 } 
	{ data_temp_13_out sc_out sc_lv 128 signal 7 } 
	{ data_temp_13_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ data_temp_12_out_i sc_in sc_lv 128 signal 8 } 
	{ data_temp_12_out_o sc_out sc_lv 128 signal 8 } 
	{ data_temp_12_out_o_ap_vld sc_out sc_logic 1 outvld 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sweep_rx0_0_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "sweep_rx0_0_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "data_temp_9", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "data_temp_9", "role": "default" }} , 
 	{ "name": "data_temp_10", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "data_temp_10", "role": "default" }} , 
 	...
 	{ "name": "data_temp_13_out", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "data_temp_13_out", "role": "default" }} , 
 	{ "name": "data_temp_13_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "data_temp_13_out", "role": "ap_vld" }} , 
 	{ "name": "data_temp_12_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "data_temp_12_out", "role": "i" }} , 
 	{ "name": "data_temp_12_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "data_temp_12_out", "role": "o" }} , 
 	{ "name": "data_temp_12_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "data_temp_12_out", "role": "o_ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	data_temp_9 { ap_none {  { data_temp_9 in_data 0 128 } } }
	data_temp_10 { ap_none {  { data_temp_10 in_data 0 128 } } }
	sweep_rx0_0_V_data_V { axis {  { sweep_rx0_0_TVALID in_vld 0 1 }  { sweep_rx0_0_TDATA in_data 0 128 } } }
	sweep_rx0_0_V_keep_V { axis {  { sweep_rx0_0_TKEEP in_data 0 16 } } }
	sweep_rx0_0_V_strb_V { axis {  { sweep_rx0_0_TSTRB in_data 0 16 } } }
	sweep_rx0_0_V_last_V { axis {  { sweep_rx0_0_TREADY in_acc 1 1 }  { sweep_rx0_0_TLAST in_data 0 1 } } }
	...
	data_temp_13_out { ap_vld {  { data_temp_13_out out_data 1 128 }  { data_temp_13_out_ap_vld out_vld 1 1 } } }
	data_temp_12_out { ap_ovld {  { data_temp_12_out_i in_data 0 128 }  { data_temp_12_out_o out_data 1 128 }  { data_temp_12_out_o_ap_vld out_vld 1 1 } } }
}
